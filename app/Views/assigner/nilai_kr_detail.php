...
<?= $this->include('content/header') ?>
			...
			<main class="content">
                ...
                <h5 class="right-aligned" style="float: right">
                    <a href="#">Home</a> / <a href="#">Assigner</a> / Detail Nilai Pemeriksaan Key Result (Assign)
                </h5>
                <h1 class="h3 mb-3"><b>Detail Nilai Pemeriksaan Key Result (Assign)</b></h1>
                    <div class="row">
                        <div class="col-12">
                        <form>
                            <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title mt-2">Assignor Rating (Assigner)</h5>
                                    <div class="col-md-6">
                                        ...
                                        <input
                                            ...
                                            value="<?= is_null($key_results['assignor_rate_q1']) ? 'Belum Diisi' : esc($key_results['assignor_rate_q1']) ?>"
                                            disabled/>
                                    </div>
                                    <div class="col-md-6">
                                        <!-- Inputan Q2 -->
                                        ...
                                        <input
                                            ...
                                            value="<?= is_null($key_results['assignor_rate_q2']) ? 'Belum Diisi' : esc($key_results['assignor_rate_q2']) ?>"
                                            disabled/>
                                    </div>
                                </div>
                                ...
                                <a href="<?= base_url('/dashboard/assign/nilai_pemeriksaan/update/' . $key_results['id_kr']) ?>"
                                    type="button"
